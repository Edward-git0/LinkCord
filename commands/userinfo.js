    ...
    exec: async (call) => {
        try {
			...
			if(!mentioned) {
				...
				.addField(`Joined Discord at`, moment(call.message.author.createdAt).format('MM/DD/YYYY'))
				.setColor('RANDOM')
				.setTimestamp()
			...
			.addField('Joined Discord At:', moment(mentioned.user.createdAt).format('MM/DD/YYYY'))
			.setColor('RANDOM')
			.setTimestamp()
